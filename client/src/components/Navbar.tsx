          ...
          >
            ...
            <li className="nav-item">
              ...
              <li className="nav-item">
                ...
                >
                  <i className="fab fa-facebook-square text-lg leading-lg text-white opacity-75"></i><span className="ml-2">Facebook Share</span>
                </a>
              </li>
              <li className="nav-item">
                <a
              ...
              <li className="nav-item">
                ...
                >
                  <i className="fab fa-pinterest text-lg leading-lg text-white opacity-75"></i><span className="ml-2">Pinterest</span>
                </a>
              </li>
            </ul>
          </div>
